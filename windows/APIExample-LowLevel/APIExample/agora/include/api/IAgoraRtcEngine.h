...
class IRtcEngineEventHandler {
  ...
  */
  ...
  /** Occurs when the audio device's volume changes.
...
class IRtcEngine : public agora::base::IEngineBase {
  ...
  */
  ...
  SDK triggers this callback within two seconds depending on the network 
   ...
   *
   * After calling this method successfully, the SDK triggers the \ref onRemoteAudioStateChanged
  ...
  */
   ...
   * This parameter will be ignored when `enabled` is set to be `false`.
   * @return
   * - 0: Success.
   * - < 0: Failure.
   */
  ...
  /** Sets the default audio route (for Android and iOS only).
   ...
   a headphone or a Bluetooth audio device, is connected. See 
